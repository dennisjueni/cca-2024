...
class Controller:
    def __init__(self):
        ...
        # self.cpu_measurements: list[list[float]] = []
    ...
    def schedule_loop(self):
        ...
        UNDERLOADED_THRESHOLD = 70

        radix_job = None
        for job in self.jobs:
            if job.job == JobEnum.RADIX:
                radix_job = job
        ...
        while True:
            ...
            radix_job_finished = radix_job.is_finished()
            ...
            if curr_job_finished:
                ...
                if not radix_job_finished or self.num_memcached_cores != 1:
                    current_job.update_cores([2, 3])
            else:
